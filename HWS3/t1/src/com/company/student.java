...
public class student {
    ...
    final static String Name="amirhossein" ;

    final static String Family="golrokhi";

    final static long Username=981113053;

    final static long Password=12345678;
    ...
    static void input()throws Exception{
        ...
        if (Student.Family.equals(student.family) && Student.Name.equals(student.name) && Student.Username == student.username && Student.Password == student.password )
            throw new Exception("Log In Successfull ");
